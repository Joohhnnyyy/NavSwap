...
import { Navigation, Fuel, Moon, Sun, Play, Pause, RotateCw } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  if (!mounted) return <div className="fixed inset-0 w-screen h-screen bg-zinc-900 animate-pulse" />;
