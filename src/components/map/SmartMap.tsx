...
import { Navigation, Fuel, Moon, Sun, Play, Pause, RotateCw, Maximize, Minimize } from 'lucide-react';
...
const SmartMap: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className={`relative w-full h-full transition-all duration-700 ${theme === 'tactical' ? 'bg-[#1c1c1e] theme-tactical' : 'bg-[#F2F2F7] theme-modern'}`}>
        ...
        `}>
          ...
          <div className="flex items-center gap-10">
            ...
            <button 
              ...
              className={`p-4 rounded-full border transition-all duration-500 hover:scale-110 active:scale-95 ${theme === 'tactical' ? 'bg-white/5 text-white/70 border-white/5' : 'bg-white/80 text-slate-500 border-white shadow-sm'}`}
