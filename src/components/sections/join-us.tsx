...
const JoinUs: React.FC = () => {
  return (
    <section 
      className="section section-join-us relative overflow-hidden bg-secondary text-secondary-foreground" 
      style={{ 
        paddingTop: '15vh', 
        paddingBottom: '15vh' 
      }}
    >
      <div className="container mx-auto px-[5vw]">
        ...
        <div className="flex flex-col mb-[2rem]">
          <h2 
            className="font-sans font-bold text-[1.5rem] tracking-[0.1em] uppercase mb-4 text-secondary-foreground"
          >
            JOIN US
          </h2>
          
          {/* Animated/Static Border Divider */}
          <div className="relative w-full h-[1px] bg-foreground flex justify-end items-center">
            <div 
              className="absolute right-0 bg-secondary pl-4 font-sans text-[10px] font-medium tracking-[0.1em] uppercase translate-y-[-1px] text-secondary-foreground"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mt-[4rem]">
          ...
          <div className="lg:col-span-4 flex flex-col items-start lg:items-end">
            ...
            >
              ...
              <span className="absolute bottom-0 left-0 w-full h-[2px] bg-foreground scale-x-0 origin-right transition-transform duration-500 group-hover:scale-x-100 group-hover:origin-left"></span>
            </a>
          </div>
        </div>
      </div>
